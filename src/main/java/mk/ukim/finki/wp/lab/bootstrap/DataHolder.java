...
public class DataHolder {
    ...
    public static final List<Genre> genres = new ArrayList<>();
    ...
    public void init(){
        ...
        songs.add(new Song("1", "Paranoid", new Genre("Metal"), 1996, new ArrayList<>()));
        songs.add(new Song("2", "Immigrant Song", new Genre("Metal"), 1998, new ArrayList<>()));
        songs.add(new Song("3", "Gimme Shelter", new Genre("Rock"), 2001, new ArrayList<>()));
        songs.add(new Song("4", "Yesterday", new Genre("Pop"), 1994, new ArrayList<>()));
        songs.add(new Song("5", "Shine on you Crazy Diamond", new Genre("Rock"), 1992, new ArrayList<>()));
    }
